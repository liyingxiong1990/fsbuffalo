<template>
  <div class="enterprise-carrier">
    ...
    <carrier-dialog :dialog="dialog" :submitCallback="submitCallback"></carrier-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    deleteAlertOpen (row) {
      ...
      this.$confirm('此操作将永久删除该条数据, 是否继续?', '提示', {
        ...
        this.$store.state.http.auto('carrier', 'delete', { data: row }).then((response) => {
